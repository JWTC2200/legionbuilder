...
const DetachmentSlotTitle = ({ slotType }: properties) => {
	...
	return (
		<h4 className="sm:w-full flex gap-1 items-center justify-center builder_title_background text-primary-50 text-graduate clip-path-halfagon-md text-center py-2 sm:text-xl font-graduate px-2 mx-2 sm:mx-0">
