...
const page = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <Link
        href="/lists/builder"
        className="px-8 py-2 mt-4 banner_background font-graduate text-lg sm:text-2xl rounded-full border-2 border-primary-950 hover:text-tertiary-700 active:text-tertiary-700 hover:border-tertiary-700 active:border-tertiary-700"
        onClick={clearList}
      >
        New List
      </Link>
