...
const SpecialRuleBox = ({ rule }: { rule: SPECIAL_RULE }) => {
  ...
  return (
    <div className="cursor-pointer hover:text-primary-800 active:text-primary-800 relative group capitalize">
      ...
      {description?.tooltip ? (
        <article className="absolute hidden p-1 border-2 border-primary-950 bg-primary-50 group-hover:block bg-white rounded-lg w-max max-w-[200px] sm:max-w-[300px] -top-2 left-0 -translate-y-full z-20 text-primary-950 text-center normal-case">
