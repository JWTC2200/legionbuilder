...
export default function NavBar() {
	...
	return (
		<Sticky className="w-full z-30">
			<div className="w-full builder_head_background py-4 px-4 lg:px-8 flex lg:flex-col justify-between lg:justify-center gap-4 items-center text-center font-subrayada">
				<Logo />
				<div
					className={
