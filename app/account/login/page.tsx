        ...
        <section className="flex flex-col gap-12 p-4 w-full lg:w-1/2">
          <form onSubmit={handleSignIn} className="flex flex-col gap-6 items-start">
            <div className="flex items-center w-full">
              <label htmlFor="email" className="font-graduate w-1/4">Email</label>
            ...
            <div className="flex items-center w-full">
              <label htmlFor="password" className="font-graduate w-1/4">Password</label>
            ...
            <div className="w-full">
              <button type="submit" className="bg-primary-500 clip-path-halfagon-sm py-1 px-4 text-primary-100 font-semibold font-graduate hover:bg-primary-500 hover:text-primary-500 ml-1/4">Login</button>
            </div>
          </form>

          <p className="p-4 bg-secondary-800 text-secondary-300 clip-path-octagon-md italic">
            Please note: An account is NOT required to use the builder. An account is only required if you want to save
            more than one list or create links for sharing with other players.
          </p>
        </section>
      </Main>
  );
